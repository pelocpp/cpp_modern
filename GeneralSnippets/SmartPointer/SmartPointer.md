...
Folgende Überlegungen haben zu einem alternativen Ansatz geführt:
  ...
  * Klassen besitzen Konstruktoren und Destruktoren
  * Wann wird speziell ein Konstruktor aufgerufen: Am Ende des Scopes des dazugehörigen Objekts.
  * Damit kann man sagen: Der Aufruf eines Konstruktor ist deterministisch &ndash; im Gegensatz zum Aufruf des `delete`-Operators.
...
Überblick über die Haupteigenschaften:
  ...
  * Lebensdauer: Das Objekt wird gelöscht, wenn das aktuelle besitzende `std::unique_ptr`-Objekt zerstört wird.
...
## Klasse `std::weak_ptr` &ndash; Beobachter ohne Besitz / Temporärer Besitz <a name="link5"></a>
