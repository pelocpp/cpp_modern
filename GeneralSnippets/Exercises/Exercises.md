...
| Aufgabe | Beschreibung |
| :- | :- |
| [Aufgabe 1](./Exercises_11_Initialization.md#aufgabe-1-brace-initialization-und-initialisierungliste) | *Brace Initialization* und Initialisierungliste<br/>(Vorausetzungen: Templates, `std::vector<>`, `std::initializer_list<>`) |
| [Aufgabe 2](./Exercises_11_Initialization.md#aufgabe-2-zeitvergleich-im-gebrauch-von-vektoren-und-initialisierunglisten) | Ein Zeitvergleich<br/>(Vorausetzungen: `std::vector<>`, `std::initializer_list<>`) |
...
| [Aufgabe 3](./Exercises_15_SmartPointers.md#aufgabe-3-betrachtungen-eines-nicht-besitzenden-zeigers) | Betrachtungen eines &bdquo;nicht besitzenden&rdquo; Zeigers<br/>(Vorausetzungen: `std::shared_ptr<>`, `std::weak_ptr<>`) |
