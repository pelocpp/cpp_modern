...
| [Aufgabe 3](./Exercises_15_SmartPointers.md#aufgabe-3-betrachtungen-eines-Zyklus-von-smart-pointer-Objekten) | Betrachtungen eines Zyklus von `std::shared_ptr<>`-Objekten<br/>(Vorausetzungen: `std::shared_ptr<>`, ggf. `std::weak_ptr<>`) |
